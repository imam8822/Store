        ...
        <div class="container jumbotron bg-light boxshadow" align="center" style="width:35%">
            ...
            <div class="text-black-50">
                ...
                <div class="form-group">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ValidationGroup="register" ControlToValidate="tb_password"  ForeColor="Red" ErrorMessage="Password cannot be empty"></asp:RequiredFieldValidator>
                </div>
                <div class="form-group">
                       ...
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ValidationGroup="register" ControlToValidate="tb_confirm"  ForeColor="Red" ErrorMessage="Password cannot be empty"></asp:RequiredFieldValidator><br />
                 ...
                 <asp:Button ID="btn_login" runat="server" Text="Register" CssClass="btn btn-success" CausesValidation="true" ValidationGroup="register" OnClick="btn_login_Click" />         
            </form>
